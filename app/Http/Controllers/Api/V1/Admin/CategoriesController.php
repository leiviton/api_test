...
use TestPax\Services\CategoryService;
...
class CategoriesController extends Controller
{
    ...
    public function store(Request $request): \Illuminate\Http\JsonResponse
    {
        ...
        if ($result['status'] == 'success') {
            return response()->json(['message' => 'Cadastro realizado com sucesso', 'status' => 'success', 'title' => 'Sucesso','category' => $result['category']], 201);
    ...
    public function update($id, Request $request): \Illuminate\Http\JsonResponse
    {
        ...
        if ($result['status'] == 'success') {
            return response()->json(['message' => 'Categoria atualizada com sucesso', 'status' => 'success', 'title' => 'Sucesso'], 200);
        } else {
            return response()->json(['message' => $result['message'], 'status' => 'error', 'title' => 'Erro'], 400);
        }
    }
    ...
    public function delete($id): \Illuminate\Http\JsonResponse
    {
        ...
        if ($result['status'] == 'success') {
            return response()->json(['message' => 'Categoria excluida com sucesso', 'status' => 'success', 'title' => 'Sucesso'], 200);
        } else {
            return response()->json(['message' => $result['message'], 'status' => 'error', 'title' => 'Erro'], 400);
        }
    }
